//Exercise 1.6: Modify the Lissajous program to produce images in multiple colors by
//adding more values to palette and then displaying them by changing the third
